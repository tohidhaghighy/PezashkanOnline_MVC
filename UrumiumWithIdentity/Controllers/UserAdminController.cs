...
namespace IdentitySample.Controllers
{
    public partial class UsersAdminController : Controller
    {
        ...
        public UsersAdminController(IFooterService footerservice,
            IUnitOfWork uow)
        {
        ...
        public UsersAdminController(ApplicationUserManager userManager, ApplicationRoleManager roleManager, string s)
        {
