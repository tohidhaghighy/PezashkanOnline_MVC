...
namespace UrumiumWithIdentity.Controllers
{
    public partial class PaymentController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string Verify = "~/Views/Payment/Verify.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_PaymentController : UrumiumWithIdentity.Controllers.PaymentController
    {
