...
namespace UrumiumMVC.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_CaptchaController : UrumiumMVC.Controllers.CaptchaController
    {
        public T4MVC_CaptchaController() : base(Dummy.Instance) { }

        [NonAction]
        partial void ImageOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult Image()
        {
